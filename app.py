...
def run_crawler():
    ...
    try: 
        ...
        has_privacy = methods.check_privacy_policy(driver)
        r.append({
            'check': 'Política de privacidade',
            'passed': has_privacy
        })
        
        has_cookie_option = methods.check_cookie_banner(driver)
        r.append({
        ...
        consent_check = methods.check_consent_before_cookies(consent_locator, driver)
        r.append({
